...
// in simulator we redefine to format for AdMob Developer console
...
{\
	NSString * exceptionName = [@"org.admob." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.admob";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIAdMobNativeItemNone = -1, 
	UIAdMobNativeItemSpinner = -2,
	UIAdMobNativeItemProgressBar = -3,
	
	UIAdMobNativeItemSlider = -4,
	UIAdMobNativeItemSwitch = -5,
	UIAdMobNativeItemMultiButton = -6,
	UIAdMobNativeItemSegmented = -7,
	
	UIAdMobNativeItemTextView = -8,
	UIAdMobNativeItemTextField = -9,
	UIAdMobNativeItemSearchBar = -10,
	
	UIAdMobNativeItemPicker = -11,
	UIAdMobNativeItemDatePicker = -12,
	
	UIAdMobNativeItemInfoLight = -13,
	UIAdMobNativeItemInfoDark = -14,
	
	UIAdMobNativeItemDisclosure = -15,
	
	UIAdMobNativeItemContactAdd = -16
};
