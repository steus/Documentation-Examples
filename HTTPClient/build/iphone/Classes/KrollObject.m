...
//@interface HTTPClientObject : NSObject
//@end

@interface HTTPClientObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[HTTPClientObject class]])
		{
			for (NSString *key in [[(HTTPClientObject*)o modules] allKeys])
			{
