...
// in simulator we redefine to format for HTTPClient Developer console
...
{\
	NSString * exceptionName = [@"org.httpclient." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.httpclient";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIHTTPClientNativeItemNone = -1, 
	UIHTTPClientNativeItemSpinner = -2,
	UIHTTPClientNativeItemProgressBar = -3,
	
	UIHTTPClientNativeItemSlider = -4,
	UIHTTPClientNativeItemSwitch = -5,
	UIHTTPClientNativeItemMultiButton = -6,
	UIHTTPClientNativeItemSegmented = -7,
	
	UIHTTPClientNativeItemTextView = -8,
	UIHTTPClientNativeItemTextField = -9,
	UIHTTPClientNativeItemSearchBar = -10,
	
	UIHTTPClientNativeItemPicker = -11,
	UIHTTPClientNativeItemDatePicker = -12,
	
	UIHTTPClientNativeItemInfoLight = -13,
	UIHTTPClientNativeItemInfoDark = -14,
	
	UIHTTPClientNativeItemDisclosure = -15,
	
	UIHTTPClientNativeItemContactAdd = -16
};
